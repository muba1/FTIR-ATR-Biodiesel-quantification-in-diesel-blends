...
def max_amplitude_FTIR(
        alcohol, concentrations, dir_path,
        plot=True, x1=1690, x2=1780):
...
def absorbance_in_range_FTIR(
        alcohol, concentrations, dir_path,
        plot=True, x1=1690, x2=1780):
    """The function calculates the sum of absorbance in the range x1-x2."""
    results = []
    col = []
    for concentration in concentrations:
        abs_conc = []
...
def integrate_FTIR(
    ...
    range of 1690-1780.
    """
    df2 = absorbance_in_range_FTIR(
        alcohol, concentrations, dir_path,
        plot=False, x1=1690, x2=1780)
